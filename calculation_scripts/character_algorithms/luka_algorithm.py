...
def dfs_algorithm_luka(stats: CharStats, user_input: UserInput) -> list[Rotation]:
    ...
    curr_energy += 2 * stack_energy_bonus * user_input.assume_ult
    e_basic_cost = 2
    ...
    stack: list = [(curr_energy, all_rotations,
                    skill_points_generated, luka_stacks)]
    ...
    while stack:
        ...
        stack.append((curr_energy + stats.basic + turn_energy + stack_energy_bonus,
                     turns + ["BASIC"], skill_points_generated + 1, luka_stacks + 1))
        ...
        stack.append((energy, turns + ["SKILL"], skill_points_generated - 1,
