...
from character_utils.characters import HUOHUO_PERCENT_ENERGY_BONUSES, CharStats
...
def _find_actions_total_energy(energy: float,
    ...
    if isinstance(trigger_count, Counter):
        ...
        elif trigger_count.num_triggers > 0:
